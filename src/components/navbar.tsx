    ...
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 lg:px-5 lg:py-5 flex justify-center">
        <div className="w-full lg:w-[75%] max-w-full">
          <div className="relative flex items-center justify-between h-20 px-4 lg:px-10 rounded-none lg:rounded-full bg-white/35 dark:bg-black/35 backdrop-filter backdrop-blur-md backdrop-saturate-150 border-2 border-border/30 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(94,234,212,0.3)] transition-all duration-500 group overflow-hidden">
